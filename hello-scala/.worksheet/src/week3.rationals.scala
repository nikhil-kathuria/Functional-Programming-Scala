...
object rationals {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(59); 
 val x= new Rational(1,3);System.out.println("""x  : week3.Rational = """ + $show(x ));$skip(27); 
	val y= new Rational(5,15);System.out.println("""y  : week3.Rational = """ + $show(y ));$skip(27); 
	val z = new Rational(3,2);System.out.println("""z  : week3.Rational = """ + $show(z ));$skip(17); val res$0 = 
	...
	y.max(z);System.out.println("""res2: week3.Rational = """ + $show(res$2));$skip(10); val res$3 = 
	x.sub(y);System.out.println("""res3: week3.Rational = """ + $show(res$3))}
}
